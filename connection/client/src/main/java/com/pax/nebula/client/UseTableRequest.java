 ...
 * @date 2023/1/10
 */
public class UseTableRequest {
    private final String serverIp;
    private final String deviceId;
    private final String tableId;

    private UseTableRequest(Builder builder) {
    ...
    public void send(@NonNull OnResponseCallback<Boolean> callback) {
        String url = HttpConstants.Order.UseTable.url(serverIp);
        RequestBody body = new FormBody.Builder()
                .add(HttpConstants.Order.UseTable.param_deviceId, deviceId)
                .add(HttpConstants.Order.UseTable.param_tableId, tableId)
                .build();
    ...
    public static class Builder {
        ...
        public UseTableRequest build() {
            return new UseTableRequest(this);
        }
    }
}
